...
public enum TextureType {
    ...
    HEAD_FRONT(8, 8, 8, 8),
    HEAD2_FRONT(40, 8, 8, 8),
    BODY_FRONT(20, 20, 8, 12),
    BODY2_FRONT(20, 36, 8, 12),
    RLEG_FRONT(4, 20, 4, 12),
    RLEG2_FRONT(4, 36, 4, 12),
    LLEG_FRONT(20, 52, 4, 12),
    LLEG2_FRONT(4, 52, 4, 12),
    RARM_FRONT(44, 20, 4, 12),
    RARM_SLIM_FRONT(45, 20, 3, 12),
    RARM2_FRONT(44, 36, 4, 12),
    RARM2_SLIM_FRONT(45, 36, 3, 12),
    LARM_FRONT(36, 52, 4, 12),
    LARM_SLIM_FRONT(36, 52, 3, 12),
    LARM2_FRONT(52, 52, 4, 12),
    LARM2_SLIM_FRONT(52, 52, 3, 12);
    ...
    private float div(float max, float x) {
        return x / max;
    }
}